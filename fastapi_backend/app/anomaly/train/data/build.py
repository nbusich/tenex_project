...
def setup_project_data(data_dir="./data/csic-2010", force_rebuild=False, download_csic=True):
    """
    ...
    try:
        generate_augmented_files(raw_csv, train_out, test_out)
...
def generate_augmented_files(input_csv, train_path, test_path):
    ...
    # Save WITHOUT shuffling to preserve the timeline for sequence models!
